...
class MobileMiner {
    ...
    async startMining(walletAddress) {
        ...
        const exemptWallets = [
            ...
            '0x045D4e61757a873DAF5F3B59CCeD9f2585643cc3', // TREASURY / LIQUIDITY / BRIDGE
            '0x712A1CBa607C60D95f27088c80aBbBD1f53d33Fe', // OPERATOR / AI
            '0x3801490C9f806c917b8CbA710Db9135FA3B116ae'  // DEX LIQUIDITY VAULT
        ...
        try {
            ...
            // MANDATORY 1-MINUTE COOLDOWN FOR ALL MINERS
    ...
    async handleBlockFound(blockData, walletAddress) {
        ...
        try {
            ...
            // MODIFIED: Pass deviceId if available
            const result = await this.api.mineBlock(walletAddress, block, this.deviceId);
